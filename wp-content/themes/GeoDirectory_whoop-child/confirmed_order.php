...
if ( is_user_logged_in() ){
  ...
  $arrProducts = tamzang_get_all_products_in_cart($current_user->ID,$pid);
        ...
        <div class="wrapper-loading">
          <table class="confirm-table" id="tb-cart">
                  ...
                  echo '<tr id="'.$product->product_id.'">';
                    echo "<td>";
                      echo '<div class="order-row">';
                        ...
                        echo '<div class="order-col-9">';
                          echo '<h4 class="product-name"><strong>'.$product->name.'</strong></h4>'.$product->short_desc;
                        echo "</div>";
                      echo "</div>";
                    ...
                    echo '<td>';
                      ...
                      echo '<button type="button" class="btn-tamzang-quantity btn-quantity quantity-right-plus btn btn-success btn-number" 
                            data-type="plus" data-id="'.$product->product_id.'" data-nonce="'.wp_create_nonce( 'update_product_cart_' . $product->product_id ).'"
                    ...
                    echo "</td>";
                    echo '<td>';
                      echo '<strong><div id="'.$product->product_id.'-price" >'.str_replace(".00", "",number_format($product->price,2)).'</div></strong>';
                    echo "</td>";
                    echo '<td>';
                      echo '<strong><div id="'.$product->product_id.'-total" >'.str_replace(".00", "",number_format($total,2)).'</div></strong>';
                    echo "</td>";
                    echo "<td>";
			...
			<tr>
                ...
                <td class="text-right"><strong><div id="sum"><?php echo $delivery_fee; ?></div></strong></td>
              </tr>
              <tr>
                <td></td>
                <td></td>
